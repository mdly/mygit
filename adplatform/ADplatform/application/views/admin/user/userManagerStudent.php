                    ...
                    <div class="col-xs-10">
                        <div>
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation"><a href="<?php echo site_url('/admin/show_teacher_list')?>">教师</a></li>
                                <li role="presentation" class="active"><a href="<?php echo site_url('/admin/show_student_list')?>">学生</a></li>
                            </ul>
                        </div>
