                    ...
                    <div class="col-xs-10">
                        <div>
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation" name = "student" class="tag active"><a href="<?php echo site_url('/admin/show_student_list')?>">学生</a></li>
                            </ul>
                        </div>
                        <div class="table-responsive">
                            ...
                            <div>
                                <form class="form-inline" method="post" action="<?php echo site_url('/admin/search_user_student')?>"> 
                                    <div class="col-xs-8">
